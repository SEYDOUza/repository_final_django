...
class User(AbstractUser):
    ...
    filire_etudiant = models.ForeignKey(
        Filiere, null=True, on_delete=models.SET_NULL)
...
class Projet(models.Model):
    ...
    fichierProjet = models.FileField(upload_to='devoirs/', validators=[FileExtensionValidator(
        allowed_extensions=['pdf', 'doc', 'docx', 'jpg', 'jpeg', 'png']), validate_file_size])
    description = models.TextField()
    date_creation = models.DateField(default=datetime.date.today)
    deadline = models.DateField(null=True)
    devoir_soumis = models.FileField(upload_to='devoirs_soumis/',  null=True, validators=[FileExtensionValidator(
        allowed_extensions=['pdf', 'doc', 'docx', 'jpg', 'jpeg', 'png']), validate_file_size])
...
class Cour(models.Model):
    ...
    fichierCour = models.FileField(upload_to='devoirs/', validators=[FileExtensionValidator(
        allowed_extensions=['pdf', 'doc', 'docx', 'jpg', 'jpeg', 'png']), validate_file_size])
    description = models.TextField()
    date_creation = models.DateField(default=datetime.date.today)
...
class Devoir(models.Model):
    ...
    fichier_soumis = models.FileField(upload_to='devoirs_soumis/', validators=[FileExtensionValidator(
        allowed_extensions=['pdf', 'doc', 'docx', 'jpg', 'jpeg', 'png']), validate_file_size])
